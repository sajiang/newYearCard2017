...
!function($){
  ...
  $.fn.let_it_snow = function(options){
    ...
    function snow() {
        ...
        for (var i = 0; i < flakeCount; i++) {
            ...
            if (settings.image == false) {
              ...
              ctx.drawImage($("img#lis_flake"+ctx.canvas.className).get(0), flake.x, flake.y, flake.size * 2, flake.size * 2);
            }
    ...
    if (settings.image != false) {
      $("<img src='"+settings.image+"' style='display: none' id='lis_flake"+ctx.canvas.className+"'>").prependTo("body")
    }
